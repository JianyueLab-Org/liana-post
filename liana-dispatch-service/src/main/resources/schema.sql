...
INSERT INTO `dispatch_bag` (`bag_no`, `origin_facility_code`, `destination_facility_code`, `route_code`, `mail_no_list`, `mail_type_code`, `status`, `mail_count`, `total_weight_grams`) VALUES
