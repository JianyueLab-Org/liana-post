...
const servicePrefixes = ['/liana-auth-service', '/liana-facility-service', '/liana-oms-service', '/liana-dispatch-service', '/liana-records-service', '/liana-transport-service'];
